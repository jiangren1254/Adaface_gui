...
" font-size: 20px; padding: 10px;")
        ...
        self.progressBar_sim.setValue(1)
...
" font-size: 16px; padding: 10px;")
        ...
        self.pushButton_faceFrom_img = QPushButton(self.centralwidget)
        self.pushButton_faceFrom_img.setObjectName(u"pushButton_faceFrom_img")
        self.pushButton_faceFrom_img.setGeometry(QRect(600, 440, 90, 39))
        self.pushButton_faceFrom_img.setMaximumSize(QSize(90, 40))
        self.pushButton_faceFrom_img.setStyleSheet(u"background-color: rgb(72, 94, 105);\n"
" color:rgb(0, 255, 0);\n"
" font-size: 16px; padding: 10px;")
...
"border: 1px solid black;")
        ...
        self.line.raise_()
        self.pushButton_faceFrom_img.raise_()
        self.label.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_faceFrom_img.setText(QCoreApplication.translate("MainWindow", u"\u8bc6\u522b\u56fe\u7247", None))
        self.label_recog_result_2.setText("")
        self.label.setText(QCoreApplication.translate("MainWindow", u"\u59d3     \u540d:", None))
        self.label_name.setText(QCoreApplication.translate("MainWindow", u"XXX", None))
